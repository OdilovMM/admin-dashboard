...
const AddProductBanner = () => {
  ...
  const { isLoading, banner, successMessage, errorMessage } = useSelector(
    (state) => state.banner
  );
  ...
  return (
    <div className="px-2 lg:px-7 pt-5">
      <h1 className="text-[#000000] font-semibold text-lg mb-3">Add Product Banner</h1>
          ...
          <div>
            ...
            <form onSubmit={update}>
              ...
              <button
                ...
                className="bg-red-500 w-[280px] hover:shadow-red-300/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3"
              >
                {isLoading ? "Submitting..." : "Update Banner"}
              </button>
            </form>
          </div>
        )}
